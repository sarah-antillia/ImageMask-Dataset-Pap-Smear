...
# split_master.py
# 2023/07/22
# This splits images and masks files in the following folders.
#   images_dir = "./Smear2005-master/severe_dysplastic/images/"
#   masks_dir  = "./Smear2005-master/severe_dysplastic/masks/"
...
def split_master(images_dir, masks_dir, output_dir):
  # 2023/07/24 Added the following line to fix seed.
  random.seed = 137
...
if __name__ == "__main__":
  try:
    images_dir = "./Smear2005-seamless-master/severe_dysplastic/images/"
    masks_dir  = "./Smear2005-seamless-master/severe_dysplastic/masks/"
    output_dir = "./Smear2005-Seamless-ImageMask-Dataset-V2/severe_dysplastic/"
